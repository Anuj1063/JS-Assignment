...
var accessrioesSection = document.getElementById("accessories");
...
for (var i = 0; i < productList.length; i++) {
  ...
  imageSection.src = productList[i].preview;
  imageSection.alt = "image";

  var textSection = document.createElement("div");
  textSection.classList.add("details");

  card.append(imageSection, textSection);
  ...
  price.style.color = "#009688";

  textSection.append(title, brand, price);

  if (productList[i].isAccessory === true) {
    accessrioesSection.append(card);
  } else {
    clothesSection.append(card);
  }
}
